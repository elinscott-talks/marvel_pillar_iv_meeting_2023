...
\begin{frame}{Koopmans functionals: theory}
   ...
   \vspace{-1.5ex}
   \begin{align*}
      E_\mathsf{Koopmans}[\rho,\only<9->{\textcolor{red}}{\{f_i\}}, \only<6-7>{\textcolor{red}}{\{\alpha_i\}}]
      ...
      +
      \underbrace{
         \only<4>{\textcolor{red}}{f_i \only<8>{\textcolor{red}}{\eta_i}}
      }_{
   ...
   \begin{overlayarea}{\textwidth}{0.5\paperheight}
      ...
      \only<5->{
         ...
         \begin{itemize}
            \item<6-> screening
            \item<8-> different variants: KI (leaves total energy unchanged), KIPZ (exact for 1-electron systems), pKIPZ
...
\begin{frame}{Extrapolating properly to the bulk limit}
