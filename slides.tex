...
\definecolor{marvelred}{HTML}{c00000}
...
\setbeamercolor{frametitle}{bg=white,fg=kgrey}
...
\setbeamercolor{under headline}{bg=marvelred}
...
\setbeamercolor{description item}{fg=marvelred}
\setbeamercolor{enumerate item}{fg=marvelred}
\setbeamercolor{itemize item}{fg=marvelred}
\setbeamercolor{itemize subitem}{fg=marvelred}
\setbeamercolor{itemize subsubitem}{fg=marvelred}
...
\setbeamertemplate{title page}
{
  ...
  \begin{center} 
  \LARGE
  \textbf{Automating the calculation of accurate band structures with Koopmans functionals}
  ...
  \begin{center}
  \footnotesize \bf \insertauthor\quad | \quad\insertshortinstitute\quad | \quad MARVEL Pillar IV Online Meeting\quad|\quad \insertdate    
  \end{center}
  %  \end{flushright}
  \end{tcolorbox}
  }
...
{
   \hspace{3ex}
   \includegraphics[height = 0.06\paperheight]{logos/SNF_logo_standard_print_color_pos_e.eps}
   \hfill
   \includegraphics[height = 0.04\paperheight]{figures/logo_marvel_color_transparent_hexagons_only.png}
   \hspace{3ex}
...
\begin{table}[t]
   ...
   \begin{tabular}{r@{ $\rightarrow$ } l *{3}{d{2.2}} >{\color{marvelred}}S[table-format = 2.2] >{\color{marvelred}}S[table-format = 2.2] d{2.2} @{$\pm$} d{1.2}}
      ...
      \multicolumn{2}{c}{ }
                                ...
                                & \multicolumn{1}{c}{
                                 \textcolor{marvelred}{\bfseries KI@[PBE,MLWFs]}}
                                & \multicolumn{1}{c}{
                                 \textcolor{marvelred}{\bfseries KIPZ@PBE}}
...
\begin{frame}{\normalsize Koopmans functionals give accurate band structures}
   \begin{figure}[t]
      ...
      \begin{subfigure}{\textwidth} %<-- changed width
         ...
         \begin{tabular}{c S[table-format = 2.2] S[table-format = 2.2] S[table-format = 2.2] S[table-format = 2.2] >{\color{marvelred}\bfseries}S[table-format = 2.2] S[table-format = 2.2]}
...
%          \draw [very thick, color=marvelred] (-5.35,-0.07) rectangle (5.4,1.6);
%       \end{tikzpicture}
%    \end{center}
%    \vspace{-2ex}
% 
...
\begin{frame}{Workflows}
   ...
   %    \begin{flushright}
   %       \begin{tcolorbox}[enhanced jigsaw, width=4cm, opacityback=0, colframe=marvelred, coltext=marvelred, left=3pt, bottom=3pt, top=3pt, right=3pt, tikz={rotate=30,transform shape}, boxrule=1.5mm]
   %          \begin{center}
...
\begin{frame}{Automating Wannierization}
   ...
   \onslide<2->{All of the above is supported by \texttt{koopmans}, but more details to be resolved... watch this space!}
...
%          \footnotesize
%          \begin{tabular}{c >{\color{marvelred}\bfseries}S[table-format = 2.2] S[table-format = 2.2] S[table-format = 2.2] S[table-format = 2.2] S[table-format = 2.2]}
...
%    \begin{center}
%       \footnotesize
%       \begin{tabular}{l l S[table-format = 2.2] S[table-format = 2.2] >{\color{marvelred}\bfseries}S[table-format = 2.2] >{\color{marvelred}\bfseries}S[table-format = 2.2] >{\color{marvelred}\bfseries}S[table-format = 2.2] S[table-format = 2.2]}
